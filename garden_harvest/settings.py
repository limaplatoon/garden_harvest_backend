"""
Django settings for garden_harvest project.
...
SECRET_KEY = 'ogc97-xzt*=cd8k%1k&vi685k=$ax0$+x7(y+^d@9qcx-h8@$)'
...
ROOT_URLCONF = 'garden_harvest.urls'
...
WSGI_APPLICATION = 'garden_harvest.wsgi.application'
